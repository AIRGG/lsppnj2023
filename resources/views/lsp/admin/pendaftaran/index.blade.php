...
@section('content')
    ...
    {{-- <div class="row">
        <div class="col-12">
            <a href="{{ route('manage.pendaftaran.create') }}" class="btn btn-primary m-1 radius-30 px-5"><i
                            ...
                            <tbody>
                                @foreach ($data as $nomor => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manage.pendaftaran.detail', ['id' => $value['id_user']]) }}"
                                                class="btn btn-info btn-sm m-1"><i class="bx bx-detail"></i></a>
                                            <a href="{{ route('manage.pendaftaran.edit', ['id' => $value['id_user']]) }}"
