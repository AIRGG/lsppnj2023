                        ...
                        <div class="row g-0">
                            <div class="col-xl-6">
                                <div class="card-body p-5">
                                    ...
                                    <div class="">
                                        <div class="form-body">
                                            <form class="row g-3" action="{{ route('landing.proses.login') }}"
                                                method="POST">
                                                @csrf
                                                <div class="col-12">
                                                    <label for="inputEmailAddress" class="form-label">Username</label>
                                                    <input name="username" type="text" class="form-control"
                                                        id="inputEmailAddress" placeholder="Masukkan Username">
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group" id="show_hide_password">
                                                        <input name="password" type="password"
                                                            ...
                                                            value="" placeholder="Masukkan Password"> <a
                                                            href="javascript:;"
                                                ...
                                                {{-- <div class="col-12 text-center">
                                                    <a href="{{ route('landing.daftar') }}"><i
                                                            class="bx bxs-chevron-right"></i> Daftar
                                                        disini..</a>
                                                </div> --}}
                                            </form>
                                        </div>
