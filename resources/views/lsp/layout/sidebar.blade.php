...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        @if (in_array($level, ['1']))
            ...
            <li>
                <a href="{{ route('manage.user.index') }}">
                    <div class="parent-icon icon-color-2"><i class="bx bx-circle"></i>
                    </div>
            ...
            <li>
                <a href="{{ route('manage.pendaftaran.index') }}">
                    ...
                    <div class="menu-title">Manage Pendaftaran</div>
                </a>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('master.prodi.index') }}"><i class="bx bx-chevron-right"></i>Program
                            Studi</a>
                    </li>
                    <li> <a href="{{ route('master.kelas.index') }}"><i class="bx bx-chevron-right"></i>Kelas</a>
                    </li>
                    <li> <a href="{{ route('master.mahasiswa.index') }}"><i
                                class="bx bx-chevron-right"></i>Mahasiswa</a>
                    </li>
                </ul>
            </li>
            @if ($level == 'admin')
        ...
        @else
            ...
            <li>
                <a href="{{ route('mahasiswa.user.create') }}">
                    <div class="parent-icon icon-color-2"><i class="bx bx-circle"></i>
                    </div>
                    <div class="menu-title">Form Daftar</div>
                </a>
            </li>
