...
{
    //
    public function mahasiswaDaftarShow(Request $request)
    {
    }
    public function mahasiswaDaftarShowCreate(Request $request)
    {
        ...
        return view('lsp.user.create', ['data' => $data, 'dataProvinsi' => $dataProvinsi]);
    }
    public function mahasiswaDaftarShowEdit(Request $request)
    {
    }
    public function mahasiswaDaftarShowDetail(Request $request)
    {
    }
    public function mahasiswaDaftarProsesAdd(Request $request)
    {
    }
    public function mahasiswaDaftarProsesEdit(Request $request)
    {
        $user = auth()->guard('user')->user();
        $id = $user->id_user;
        ...
        $table->provinsi_lahir = $provinsi_lahir;
        $table->id_kotkab_lahir = $form_id_kotkab_lahir;
        $table->kotkab_lahir = $kabupaten_lahir;
        ...
        return redirect()->route('mahasiswa.user.create');
    }
    public function mahasiswaDaftarProsesDelete(Request $request)
    {
    }
}
